...
const About = () => {
    ...
    return (
        ...
        >
            ...
            <p>
                When I'm not coding, you'll find me playing football and cricket with friends or enjoying some video game time. I love staying active through physical games. Explore my portfolio to see how my tech skills can contribute to your company!
            </p>
        </motion.section>
    )
}
